...
def main():
    ...
    # Glob mode: repo_root/tests/papyrus-trim/
    # __file__ lives at <repo_root>/skills/papyrus-trim/scripts/benchmark.py
    # Walk up four dirs: scripts → papyrus-trim → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "papyrus-trim"
