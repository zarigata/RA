...
bun test ../ra/tests/runtime.test.ts ../ra/tests/benchmark-artifacts.test.ts ../ra/tests/run-command.test.ts ../ra/tests/session.test.ts ../ra/tests/permission.test.ts ../ra/tests/custom-commands.test.ts ../ra/tests/subagents.test.ts ../ra/tests/checkpoint.test.ts ../ra/tests/symbols.test.ts ../ra/tests/mcp.test.ts ../ra/tests/daemon.test.ts ../ra/tests/diagnostics.test.ts ../ra/tests/airgap.test.ts ../ra/tests/selfheal.test.ts ../ra/tests/diff.test.ts ../ra/tests/search.test.ts ../ra/tests/replay.test.ts ../ra/tests/swarm.test.ts
