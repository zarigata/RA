...
bun test ../ra/tests/runtime.test.ts ../ra/tests/benchmark-artifacts.test.ts ../ra/tests/run-command.test.ts ../ra/tests/session.test.ts ../ra/tests/permission.test.ts ../ra/tests/custom-commands.test.ts ../ra/tests/subagents.test.ts ../ra/tests/checkpoint.test.ts
